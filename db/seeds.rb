...
#Review.create(user_id: user1.id, movie: movie1, comment: "Great Movie", rating: 5)
#Review.create(user_id: user2.id, movie: movie1, comment: "Not bad", rating: 3)
#Review.create(user_id: user1.id, movie: movie2, comment: "Good fantasy story", rating: 4)